                ...
                "majors": {
                    "7310101": {
                        ...
                        "programs": [
                            ...
                            {
                                "ten": "Kinh tế và quản lý nguồn nhân lực",
                                "ma_xt": "7310101_3",
                            },
                    ...
                    "7310108": {
                        ...
                        "programs": [
                            ...
                            {
                                "ten": "Khoa học tính toán trong Tài chính và Bảo hiểm",
                                "ma_xt": "EP02",
                            },
                ...
                "majors": {
                    "7460108": {
                        ...
                        "programs": [
                            ...
                            {
                                "ten": "Công nghệ Logistics và Quản trị chuỗi cung ứng (EP20)",
                                "ma_xt": "EP20",
                            },
                        ],
                    },
                ...
                "majors": {
                    ...
                    "7480201": {
                        ...
                        "programs": [
                            ...
                            {
                                "ten": "Công nghệ thông tin và chuyển đổi số (CLC)",
                                "ma_xt": "CLC1",
                            },
                        ],
                    },
            ...
            "75101": {
                ...
                "majors": {
                    "7510605": {
                        ...
                        "programs": [
                            {
                                "ten": "Logistics và quản lý chuỗi cung ứng",
                                "ma_xt": "7510605",
                            },
                            {
                                "ten": "Logistics và quản lý chuỗi cung ứng (CLC)",
                                "ma_xt": "CLC3",
                            },
                            {
                                "ten": "Logistics và quản lý CCU tích hợp chứng chỉ quốc tế (LSIC)",
                                "ma_xt": "EP14",
                            },
                        ],
                    },
                ...
                "majors": {
                    "7850101": {
                        ...
                        "programs": [
                            ...
                            {
                                "ten": "Công nghệ môi trường và phát triển bền vững",
                                "ma_xt": "EP26",
                            },
                        ],
                    },
    ...
    for ma_nganh, progs in by_major.items():
        ...
        for p in progs:
            ...
            if mxt_up.startswith("CLC"):
                ...
                ptype = "🟣 Tiên tiến"
            elif mxt_up.startswith(("EP", "EBBA", "EPMP")):
                ptype = "🟢 EP"
...
_MAJOR_SYNONYMS_TAXONOMY_ADDITIONS: list[tuple] = [
    ...
    (re.compile(r"\bcntt\b|\bit\b|m[aá]y\s*t[ií]nh(?!\s*khoa\s*h[oọ]c)", _F), "công nghệ thông tin"),
    (re.compile(r"data\s*science|khdt|khoa\s*h[oọ]c\s*d[uữ]\s*li[eệ]u", _F), "khoa học dữ liệu"),
    (re.compile(r"logistics|chu[oỗ]i\s*cung\s*[uứ]ng|scm\b", _F), "logistics và quản lý chuỗi cung ứng"),
    (re.compile(r"du\s*l[iị]ch|kh[aá]ch\s*s[aạ]n|nh[àa]\s*h[aà]ng\b", _F), "quản trị khách sạn"),
    (
        re.compile(r"m[oô]i\s*tr[uư][oờ]ng|b[eề]n\s*v[uữ]ng|bi[eế]n\s*[dđ][oổ]i\s*kh[ií]\s*h[aậ]u", _F),
        "quản lý tài nguyên và môi trường",
    ),
    (re.compile(r"kinh\s*t[eế]\s*n[oô]ng\s*nghi[eệ]p|n[oô]ng\s*nghi[eệ]p", _F), "kinh tế nông nghiệp"),
]
...
__all__ = [
    ...
    "enrich_admission_entry_with_taxonomy",
    "find_programs_by_field",
    "find_programs_by_group",
    "find_programs_by_major",
    "format_field_answer",
    "get_context_for_admission_code",
    "get_context_for_major",
